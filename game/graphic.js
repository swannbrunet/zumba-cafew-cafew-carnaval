function init()
{
    ...
    enemie = new Enemie("Enemie1", 0xff0000, new THREE.Vector2(0, 0), 0);
    scene.add(enemie.graphic);
...
{
    colors = Array(0xff0000, 0x00ff00, 0x0000ff, 0xffffff);
    ...
    for (x = minX; x <= maxX; x = x+sizeOfTileX){
        for (y = minY; y <= maxY; y = y+sizeOfTileY){
            ...
            if ((x - minX) / sizeOfTileX === 6 && (y - minY) / sizeOfTileY === 5 ) {
                color = 0xffffff;
            }
            if (0x000000 != color)
            {
